...
export interface ShowcaseTestimonial {
  /** Large photo of the testimonial author */
  image: string;
  imageAlt: string;
  /** Author name */
  name: string;
...
/**
 * TestimonialShowcase -- a bold testimonial section with a large author
 * photo alongside the quote text, wrapped in a colored background card.
 * Previous/next navigation arrows cycle through testimonials with a
 * sliding transition.
 */
