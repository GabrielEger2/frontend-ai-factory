...
export interface TestimonialsStaggerProps {
  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        boxShadow: isActive
          ? "0px 8px 0px 4px hsl(var(--bc))"
          : "0px 0px 0px 0px hsl(var(--bc))",
      }}
      transition={{
        type: "spring",
        mass: 3,
...
/**
 * TestimonialsStagger -- a fan/carousel of overlapping testimonial cards
 ...
 */
export default function TestimonialsStagger({
  testimonials: testimonialsProp,
  sectionHeight = 600,
  cardSizeLg = 365,
  cardSizeSm = 290,
  className,
}: TestimonialsStaggerProps) {
