...
export interface ContentAuthorSplitProps {
...
/**
 * ContentAuthorSplit -- a content section with a wide banner image followed
 ...
 */
export default function ContentAuthorSplit({
  bannerImage,
  bannerImageAlt,
  authorImage,
  authorImageAlt,
