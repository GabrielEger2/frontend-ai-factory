...
export interface ContentFeaturesListProps {
...
/**
 * ContentFeaturesList -- a centered header with a grid of feature items,
 ...
 */
export default function ContentFeaturesList({
  label,
  headline,
  description,
  features,
