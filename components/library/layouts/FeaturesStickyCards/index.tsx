...
export interface FeaturesStickyCardsProps {
  ...
  cards: FeatureCard[];
  /** CTA button style applied to all cards */
  ctaStyle?: CtaVariant;
  /** CTA color scheme applied to all cards */
...
export default function FeaturesStickyCards({
  headline,
  subheadline,
  cards,
  ctaStyle = "default",
