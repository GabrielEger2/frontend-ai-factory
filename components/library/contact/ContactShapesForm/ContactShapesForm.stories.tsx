...
/** Boutique architecture studio — highlighted "Contact" word, default CTA. */
...
/** Independent dental clinic — word-by-word headline reveal with a sliding CTA. */
export const DentalClinic: Story = {
  args: {
    headline: "Book Your Visit Today",
    revealHeadline: true,
...
/** Coastal restaurant — highlighted "Reserve" word with an accent draw-outline CTA. */
export const CoastalRestaurant: Story = {
  args: {
    headline: "Reserve a Table",
    highlightWord: "Reserve",
...
/** SaaS onboarding team — embedded interactive map and a glowing primary CTA. */
...
/** Local real estate agency — neighborhood office with a dot-expand neutral CTA. */
